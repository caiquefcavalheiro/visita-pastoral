...
const Conversion = () => {
  ...
  const howDidSDA = useWatch({ control, name: "howDidSDA" });

  const howYouStudyBible = useWatch({ control, name: "howYouStudyBible" });

  const decidingBaptized = useWatch({ control, name: "decidingBaptized" });
