...
<body>
    <main>
        ...
        <section class="section" style="height: 830px;">
            <h3 class="section_title">CONVERSÃO</h3>
            <div class="section_conversion_container" style="height: 100%">
                <div class="section_conversion_aside" style="width: 70%; border-right: 0.5px solid #000000">
                    <div class="section_second_field" style="width: 100%; border-right: none; height: 288px">
                        <p>
                    ...
                    <div class="section_conversion_divide_container">
                        <div class="section_conversion_container_checkbox" style="border-right: 1px solid #000000">
                            <p>
                ...
                <div class="section_conversion_aside" style="width: 30%">
                    ...
                    <div class="section_second_field" style="border-bottom: 0.5px solid #000000; border-right: none">
            ...
            <div class="section_term">
                ...
                <div class="section_user_information">
                    <div class="section_user_information_container">
                        ...
                        <div>
                            <div class="section_user_information_instructor">
                                <label style="font-size: 40px ;">1.</label>
                                <input type="text" value="${motherName}" />
                            </div>
                            <div class="section_user_information_instructor">
                                <label style="font-size: 40px ;">2.</label>
                                <input type="text" value="${fatherName}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section_user_information_container" style="border-right: none">
                        ...
                        <div style="height: 320px; border-top: 1px solid #000000">
        ...
        <footer class="footer" style="height: 800px;">
            <p>
