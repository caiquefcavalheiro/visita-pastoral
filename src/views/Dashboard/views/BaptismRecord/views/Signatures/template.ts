        ...
        <header>
          <div class="header">
            ...
            <div class="header_principal">
              ...
              <div class="header_div">
                <div class="header_checkbox">
                  <input type="checkbox" ${action === "Rebatismo*" && "checked"}
                  />
                  <h2>Rebatismo*</h2>
                </div>
              ...
              <div class="section_conversion_divide_container">
                ...
                <div class="section_conversion_container_checkbox">
                  ...
                  >
                    ...
                    <div class="section_conversion_checkbox">
                      <input type="checkbox" ${
                        howYouStudyBible === "Estudo Bíblico on-line" &&
                        "checked"
                      }/>
                    ...
                    <div class="section_conversion_checkbox">
                      <input type="checkbox" ${
                        howYouStudyBible === "Ouvi sermões na igreja" &&
                        "checked"
                      }/>
                    ...
                    <div class="section_conversion_checkbox">
                      <input type="checkbox" ${
                        howYouStudyBible === "Estudei pouco a Bíblia" &&
                        "checked"
                      }/>
          ...
          <div class="section_declaration_container">
            ...
            <div class="section_declaration_checkbox_container">
              <div class="section_declaration_checkbox">
                <div class="header_checkbox_options_position">
                  <p>S</p>
                  <input type="checkbox" ${declaration10 === "Sim" && "checked"}
                  />
                </div>
                <div class="header_checkbox_options_position">
                  <p>N</p>
                  <input type="checkbox" ${declaration10 === "Não" && "checked"}
                  />
                </div>
              </div>
              <p>
            ...
            <div class="section_declaration_checkbox_container">
              <div class="section_declaration_checkbox">
                <div class="header_checkbox_options_position">
                  <p>S</p>
                  <input type="checkbox" ${declaration11 === "Sim" && "checked"}
                  />
                </div>
                <div class="header_checkbox_options_position">
                  <p>N</p>
                  <input type="checkbox" ${declaration11 === "Não" && "checked"}
                  />
                </div>
              </div>
              <p>
            ...
            <div id="fix_border" class="section_declaration_checkbox_container">
              <div class="section_declaration_checkbox">
                <div class="header_checkbox_options_position">
                  <p>S</p>
                  <input type="checkbox" ${declaration12 === "Sim" && "checked"}
                  />
                </div>
                <div class="header_checkbox_options_position">
                  <p>N</p>
                  <input type="checkbox" ${declaration12 === "Não" && "checked"}
                  />
                </div>
              </div>
              <div>
          ...
          <div class="section_term">
            ...
            <div class="section_user_information">
              ...
              <div class="section_user_information_container">
                ...
                <div>
                  <div class="section_user_information_instructor">
                    <img src="${fatherSignature?.signature}" alt="" />
                  </div>
                  <div class="section_user_information_instructor">
                    <img src="${motherSignature?.signature}" alt="" />
                  </div>
                </div>
              </div>
              <div
