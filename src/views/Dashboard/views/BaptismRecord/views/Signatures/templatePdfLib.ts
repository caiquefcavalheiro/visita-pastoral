    ...
    <style>
        ...
        * {
        ...
        main {
            width: 100%;
            height: 100%;
            border: ${4 / normalize}mm solid #000000;
        }

        .header {
            display: flex;
            height: ${425 / normalize}mm;
        }

        .header_img {
            width: ${425 / normalize}mm;
            border-right: ${1 / normalize}mm solid #000000;
        ...
        .header_aside input {
            width: ${40 / normalize}mm;
            height: ${32 / normalize}mm;
        }
        ...
        .section_second_field {
            border-top: ${1 / normalize}mm solid #000000;
            border-right: ${1 / normalize}mm solid #000000;
        }
        ...
        .section_conversion_checkbox_container {
            display: flex;
            flex-wrap: wrap;
            margin-top: ${10 / normalize}mm;
        }

        .section_conversion_checkbox {
            width: 48%;
            margin-left: ${10 / normalize}mm;
            margin-bottom: ${10 / normalize}mm;
        }
        ...
        .section_conversion_divide_container {
            border-top: ${0.5 / normalize}mm solid #000000;
            display: flex;
            height: 100%;
        }
        ...
        .section_declaration_checkbox {
            display: flex;
            gap: ${10 / normalize}mm;
            border-right: ${1 / normalize}mm dotted #000000;
            padding: ${5 / normalize}mm ${8 / normalize}mm;
        }
        ...
        .section_term h3 {
            padding: ${10 / normalize}mm ${5 / normalize}mm;
            text-align: center;
            letter-spacing: ${2 / normalize}mm;
            border-top: ${1 / normalize}mm solid #000000;
            background-color: #55555540;
            font-size: 40rem;
        }
        ...
        .section_user_information_instructor {
            ...
            align-items: center;
            padding: ${5 / normalize}mm ${10 / normalize}mm;
            min-height: ${160 / normalize}mm;
            height: max-content;
            border-top: ${1 / normalize}mm solid #000000;
        }

        .section_user_information_instructor img {
            width: ${400 / normalize}mm;
            margin: 0 auto;
            height: ${115 / normalize}mm;
        }

        #user_signature {
            height: ${300 / normalize}mm;
            width: 100%;
            padding: ${5 / normalize}mm ${10 / normalize}mm;
            object-fit: contain;
        }
        ...
        .footer_last_text {
            border-right: ${6 / normalize}mm solid white;
        }
        ...
        .section_ceremony_signature {
            ...
            height: 100%;
            width: 34.2%;
            border-bottom: ${0.5 / normalize}mm solid #000000
        }
...
<body id="print">
    <main>
        <header>
            <div class="header">
                ...
                <div class="header_principal">
                    ...
                    <h3>
                        PREENCHA A FICHA COM A LETRA DE FORMA E NÃO DEIXE CAMPOS SEM
                        RESPOSTA
                    </h3>
                    <div class="header_div">
                        <div class="header_checkbox">
                            <input type="checkbox" ${
                              action === "Batismo" && "checked"
                            } />
                            <h2>Batismo</h2>
                        </div>
                    ...
                    <div class="header_div">
                        ...
                        <p>
                            Igreja/Grupo e localidade onde foi membro:
                            ${churchWhereHeWasAmember}
                        </p>
                    </div>
                </div>
        ...
        <section class="section" style="min-height: ${750 / normalize}mm;">
            ...
            <div class="section_information">
                ...
                <div class="section_identification_line2">
                    ...
                    <div class="section_second_field" style="width: 100%; border-right: none;">
                ...
                <div class="section_identification_line3">
                    ...
                    <div class="section_second_field" style="width: 50%; border-right: none;">
                        <p>Nome do pai</p>
                ...
                <div class="section_identification_line5">
                    ...
                    <div class="section_second_field" style="width: 50%">
                        ...
                        <input type="text" value="${countryOfResidence}" />
                    </div>
                    <div class="section_second_field" style="width: 50%; border-right: none">
                        <p>CEP</p>
                ...
                <div class="section_identification_line6">
                    ...
                    <div class="section_second_field" style="width: 30%; border-right: none">
        ...
        <section class="section" style="height: ${1000 / normalize}mm;">
            <h3 class="section_title">CONVERSÃO</h3>
            <div class="section_conversion_container" style="height: 100%">
                <div class="section_conversion_aside" style="width: 70%; border-right: ${
                  0.5 / normalize
                }mm solid #000000">
                    <div class="section_second_field" style="width: 100%; border-right: none; height: ${
                      288 / normalize
                        ...
                        <div>
                            <input type="text" value="1. ${firstBibleInstructor}" />
                            <input type="text" value="2. ${secondBibleInstructor}" />
                        </div>
                    </div>
                    <div class="section_conversion_divide_container">
                        <div class="section_conversion_container_checkbox" style="border-right: ${
                          1 / normalize
                        }mm solid #000000">
                            <p>
                            ...
                            <div class="section_conversion_checkbox_container" style="height: 100%">
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howDidSDA === "Acampamento/retiro" &&
                                      "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howDidSDA === "Quebrando o Silêncio" &&
                                      "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howDidSDA === "TV" && "checked"
                                    } />
                                    <label>TV</label>
                                </div>
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howDidSDA === "Instituição de saúde" &&
                                      "checked"
                                    } />
                        ...
                        <div class="section_conversion_container_checkbox">
                            ...
                            <div class="section_conversion_checkbox_container" style="height: 100%">
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Estudo Bíblico individual" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Estudo Bíblico on-line" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Classe Bíblica da igreja" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Ouvi sermões na igreja" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Classe Bíblica Educação" && "checked"
                                    } />
                                    <label>Classe Bíblica Educação</label>
                                </div>
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible === "Pequeno Grupo" &&
                                      "checked"
                                    } />
                                    <label>Pequeno Grupo</label>
                                </div>
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Estudei pouco a Bíblia" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Escola Bíblica Novo Tempo" && "checked"
                                    } />
                                ...
                                <div class="section_conversion_checkbox">
                                    <input type="checkbox" ${
                                      howYouStudyBible ===
                                        "Escola Cristã de Férias" && "checked"
                                    } />
                ...
                <div class="section_conversion_aside" style="width: 30%">
                    ...
                    <div class="section_second_field" style="border-bottom: ${
                      0.5 / normalize
                    }mm solid #000000; border-right: none">
                    ...
                    <div class="section_conversion_container_checkbox">
                        ...
                        <div class="section_conversion_checkbox_container" style="height: 100%">
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Missão Calebe" &&
                                  "checked"
                                } />
                                <label>Missão Calebe</label>
                            </div>
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Convicção pessoal" &&
                                  "checked"
                                } />
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Pequeno Grupo" &&
                                  "checked"
                                } />
                                <label>Pequeno Grupo</label>
                            </div>
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Desbravadores/Avent" &&
                                  "checked"
                                } />
                                <label>Desbravadores/Avent</label>
                            </div>
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Programa Reencontro" &&
                                  "checked"
                                } />
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Educação Adventista" &&
                                  "checked"
                                } />
                                <label>Educação Adventista</label>
                            </div>
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Escola Sabatina" &&
                                  "checked"
                                } />
                                <label>Escola Sabatina</label>
                            </div>
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Semana de Oração" &&
                                  "checked"
                                } />
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Evangelismo público" &&
                                  "checked"
                                } />
                                <label>Evangelismo público</label>
                            </div>
                            ...
                            <div class="section_conversion_checkbox">
                                <input type="checkbox" ${
                                  decidingBaptized === "Família/parentes" &&
                                  "checked"
                                } />
                                <label>Família/parentes</label>
                            </div>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration0 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration0 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration1 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration1 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration2 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration2 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration3 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration3 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration4 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration4 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration5 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration5 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration6 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration6 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration7 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration7 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration8 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration8 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div class="section_declaration_checkbox_container">
                    <div class="section_declaration_checkbox">
                        <div class="header_checkbox_options_position">
                            <p>S</p>
                            <input type="checkbox" ${
                              declaration9 === "Sim" && "checked"
                            } />
                        </div>
                        <div class="header_checkbox_options_position">
                            <p>N</p>
                            <input type="checkbox" ${
                              declaration9 === "Não" && "checked"
                            } />
                        </div>
                    </div>
                    <p>
                ...
                <div id="fix_border" class="section_declaration_checkbox_container">
                    ...
                    <div>
                        ...
                        <div class="section_second_field" style="border: none">
                            ...
                            <input style="height: 100%" type="text" value="${whoWillIDisciple}" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section" style="height: auto;">
            <div class="section_term">
                ...
                <h3>
                    ...
                    <a href=" http://adv.st/privacidade" target="_blank">Adv Privacidade</a>
                </h3>
                <div class="section_user_information">
                    <div class="section_user_information_container">
                        ...
                        <div>
                            <div class="section_user_information_instructor">
                                <label style="font-size: 40rem ;">1.</label>
                                <input type="text" value="${motherName}" />
                            </div>
                            <div class="section_user_information_instructor">
                                <label style="font-size: 40rem ;">2.</label>
                                <input type="text" value="${fatherName}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section_user_information_container">
                        ...
                        <div>
                            <div class="section_user_information_instructor">
                                <img src="${motherSignature?.signature}" />
                            </div>
                            <div class="section_user_information_instructor">
                                <img src="${fatherSignature?.signature}" />
                            </div>
                        </div>
                    </div>
                    <div class="section_user_information_container" style="border-right: none;">
                        <div class="section_user_information_container_title">
                            <p id="information">Assinatura do candidato/a</p>
                        </div>
                        <div style="height: ${320 / normalize}mm; border-top: ${
    1 / normalize
  }mm solid #000000">
                            <img id="user_signature" src="${
                              candidateSignature?.signature
                            }" />
                        </div>
                    </div>
                ...
                <div class="section_ceremony_principal_container">
                    ...
                    <div class="section_ceremony_container">
                        <div class="section_second_field" style="width: 40%">
                            ...
                            <input type="text" value="${nameTheChurch}" />
                        </div>
                        <div class="section_second_field" style="width: 60%">
                            <p>Cidade/UF da igreja/grupo organizado</p>
                            <input type="text" value="${cityChurchOrganizedGroup}" />
                        </div>
                    </div>
                    <div class="section_ceremony_container">
                        <div class="section_second_field" style="width: 40%">
                            <p>Data e voto da Reunião Regular/Administrativa</p>
                            <input type="text" value="${dateAndCoteTheAdministrativeMeeting}" />
                        </div>
                        <div class="section_second_field" style="width: 60%">
                            <p>Nome secretário/a da igreja/grupo organizado</p>
                            <input type="text" value="${nameSecretaryOrganizedGroup}" />
                        </div>
                    </div>
                </div>
                <div class="section_ceremony_signature">
                    <img src="${pastorSignature?.signature}" />

                    <p>Assinatura pastor oficiante</p>
                    <img src="${secretaryOrResponsibleGroup?.signature}" />
