  ...
  <body>
        ...
        <div class="header">
          ...
          <div class="header_principal">
            ...
            <div class="header_div">
              ...
              <p>Data da remoção: 23/10/2022</p>
            </div>
            <div class="header_div">
              <div class="header_checkbox">
                <input type="checkbox" />
              ...
              <p>Motivo: motivo</p>
              <p>
                Igreja/Grupo e localidade onde foi membro: localidadeMembro
              </p>
            </div>
          </div>
        </div>
    ...
    <footer class="footer">
      <p>
        ...
        como membro pela igreja/grupo organizado. Esta ficha só será válida com
        as três assinaturas: candidato/a, pastor oficiante e secretário/a da
        igreja/grupo organizado onde será membro.
      </p>
      <section class="section">
        ...
        <div class="section_ceremony_principal_container">
          ...
          <div class="section_ceremony_container">
            ...
            <div class="section_second_field" style="width: 60%">
              ...
              <input type="text" value="Cidade/UF da igreja/grupo organizado" />
            </div>
          </div>
          <div class="section_ceremony_container">
            <div class="section_second_field" style="width: 40%">
      ...
      <p class="footer_last_text">
        Esta via deve ser destruída pela Secretaria do Campo ao finalizar o ano
        corrente, confirmando primeiro se os dados do membro e a cópia desta
        ficha digitalizada foram inseridos corretamente no ACMS.
      </p>
    </footer>
  </body>
</html>`;
